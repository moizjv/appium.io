...
The main guide for getting started writing and running tests is [the running tests](/slate/en/master/#real-devices.md).
...
See [finding elements](/slate/en/master/#touch-actions.md) like tap, flick, and swipe.
